        ...
        <aside className="h-screen">
            <nav className="h-full flex flex-col bg-white border-r shadow-sm">
                <div className="p-4 pd-2 flex justify-between item-center">
                    <img src="./src/assets/logoMagicClub.jpg" className={`overflow-hidden transition-all ${
              expanded ? "w-10" : "w-0"
            }`} alt="" />
...
export function SidebarItem({icon, text, active, alert }){
    ...
    return (
        <li className={
        `relative flex items-center py-2 px-3 my-1 font-medium rounded-nd cursor-pointer transition-colors 
        ${
          active
